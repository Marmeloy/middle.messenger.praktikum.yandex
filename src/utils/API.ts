    ...
    constructor() {
        ...
        this.endpoints = {
            auth: {
                ...
                user: {
                    get: (data: FormData):Promise<XMLHttpRequest> => {
                        return http.get(this.location+'auth/user');
                    }
                },
                logout: {
                    post: ():Promise<XMLHttpRequest> => {
                        return http.post(this.location+'auth/logout');
                    }
                }
            },
            chats: {
                ...
                token: {
                    post: (data: FormData):Promise<XMLHttpRequest> => {
                        return http.post(this.location+'chats/token/' + data.get('id'));
                    }
                },
                users: {
            ...
            users: {
                get: (data:FormData):Promise<XMLHttpRequest> => {
                    return http.get(this.location+'user/'+data.get('id'));
                },
                search: {
                    post: (data:FormData):Promise<XMLHttpRequest> => {
                        let options = {
